! function(e) {
            ...
            return (0, A.default)(e, [{
                    ...
                    var a = function() {
                        ...
                        u = function(t) {
                            ...
                            switch ("string" == typeof n && (n = JSON.parse(n)), e.logger(n), n.event) {
                                ...
                                case "playProgress":
                                case "timeupdate":
                                    null !== o.playTimeout && l(), n.data.percent >= .98 && e.timeCode.start > 0 && i("seekTo", e.timeCode.start)
                            }
                            switch (n.method) {
                                case "getVideoHeight":
                ...
                value: function(e) {
                    ...
                    var r = n.parentNode.clientWidth,
                        ...
                        c = 0,
                        l = 0;
                    a > s ? (c = r * t, l = r * t / s, n.style.width = c + "px", n.style.height = l + "px") : s > a ? (c = i * t * s, l = i * t, n.style.width = c + "px", n.style.height = l + "px") : (c = r * t, l = i * t, n.style.width = c + "px", n.style.height = l + "px"), n.style.left = 0 - (c - r) / 2 + "px", n.style.top = 0 - (l - i) / 2 + "px"
                }
            }, {
                key: "setSpeed",
                value: function(e) {
    ...
    e.exports = function(e, t, n, g, m, b, w) {
        ...
        if (O && (E = f(O.call(new e)), E !== Object.prototype && (u(E, T, !0), o || s(E, d) || a(E, d, v))), C && I && I.name !== y && (F = !0, R = function() {
                return I.call(this)
    ...
    var o = n(17),
        ...
        c = function(e, t, n) {
            ...
            for (l in n) u = !d && b && void 0 !== b[l], u && l in g || (f = u ? b[l] : n[l], g[l] = A && "function" != typeof b[l] ? n[l] : y && u ? i(f, o) : v && b[l] == f ? function(e) {
                ...
                return t[s] = e[s], t
            }(f) : p && "function" == typeof f ? i(Function.call, f) : f, p && ((g.virtual || (g.virtual = {}))[l] = f, e & c.R && m && !m[l] && a(m, l, f)))
        };
    ...
    var o = n(23),
        ...
        l = function() {
            var e, t = n(28)("iframe"),
                ...
                r = "<",
                a = ">";
            for (t.style.display = "none", n(49).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write(r + "script" + a + "document.F=Object" + r + "/script" + a), e.close(), l = e.F; o--;) delete l[c][i[o]];
            return l()
        };
    ...
    _ || (R = function() {
        ...
        var e = d(arguments.length > 0 ? arguments[0] : void 0),
            t = function(n) {
                this === U && t.call(L, n), r(this, B) && r(this[B], e) && (this[B][e] = !1), Z(this, e, x(1, n))
            };
        return i && D && Z(U, e, {
            configurable: !0,
            set: t
                ...
                v(function() {
                    for (var o = e._v, r = 1 == e._s, i = 0, a = function(t) {
                            var n, i, a = r ? t.ok : t.fail,
                                ...
                                l = t.domain;
                            try {
                                a ? (r || (2 == e._h && O(e), e._h = 1), a === !0 ? n = o : (l && l.enter(), n = a(o), l && l.exit()), n === t.promise ? c(m("Promise-chain cycle")) : (i = T(n)) ? i.call(n, s, c) : s(n)) : c(o)
                            } catch (e) {
                                c(e)
                            }
                        }; n.length > i;) a(n[i++]);
        ...
        window.Singleton.create({
            ...
            bindUI: function() {
                e.Global.on("tweak:change", function(t) {
                    t.config && "Site Navigation" === t.config.category ? e.one("#mobileNavToggle").set("checked", !0) : e.one("#mobileNavToggle").set("checked", !1), "transparent-header" === t.getName() && o(function() {
                        r()
                    }, 100, this)
                });
