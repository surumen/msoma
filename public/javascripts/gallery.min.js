...
gutter:l("gridSpacing",!0),columnWidth:l("gridSize",!0),aspectRatio:n(l("aspect-ratio"))},historyHash:!0});b.gallery.all(".arrow").each(function(a){a.setStyle("top",b.slideWrapper._node.clientHeight/2)});!t&&"thumbnails"===r&&(m=new c.Squarespace.Gallery2({container:".thumbnail-wrapper",currentIndex:u,loaderOptions:{mode:"fill",load:!0},lazyLoad:!0,design:"strip"}),k.addChild(m));a=k.after("currentIndexChange",s);s();g=k.after("image-loaded",x);x();b.gallery.addClass(d.ready);q.push(a,g)}function p(a){"function"===
...
!Modernizr.touch&&q.push(c.on("mousemove",function(a){w()&&z(a,!1)},b.gallery.one(".slides-controls")),c.on("mouseleave",function(a){w()&&(z(a,!0),b.gallery.removeClass(d.iframe))},b.gallery.one(".slides-controls")),c.on("mouseenter",function(a){w()&&y()&&b.gallery.addClass(d.iframe)},b.gallery.one(".slides-controls")));q.push(c.on("keydown",B))}function h(a,b){q.push(c.Global.on("tweak",function(c){c.getName()===a&&"function"===typeof b&&(c=c.getValue(),"true"===c?c=!0:"false"===c&&(c=!1),b(c))}))}
function D(){h("gallery-loop",f);h("gallery-transitions",f);h("gallery-auto-crop",f);h("gallery-navigation",function(a){"Thumbnails"===a&&!b.gallery.one(".thumbnail-wrapper img[src]")&&f();x()});h("gallery-autoplay",function(a){k.set("autoplay",a)});h("gallery-aspect-ratio",function(){f()});h("galleryAutoplaySpeed",function(){p(f)});h("galleryInfoBackground",function(){s()});h("gallery-design",f);h("aspect-ratio",f);h("gridSpacing",f);h("gridSize",f);c.Global&&q.push(c.Global.on(["tweak:reset","tweak:close"],
function(a){c.later(500,this,f)},this))}var b={body:c.one("body"),gallery:c.one(".sqs-system-gallery"),slideWrapper:c.one(".sqs-system-gallery").one(".gallery-wrapper"),slidesAndControls:c.one(".sqs-system-gallery").one(".slides-controls"),circles:c.one(".sqs-system-gallery").one(".circles")},d={show:"show",ready:"sqs-system-gallery-ready",interaction:"sqs-system-gallery-interaction",mouseenterleft:"sqs-system-gallery-hover-slides-left",mouseenterright:"sqs-system-gallery-hover-slides-right",init:"sqs-system-gallery-init",
circlesNav:"gallery-navigation-circles",crop:"gallery-auto-crop",iframe:"sqs-system-gallery-video-iframe"},k=null,m=null,A=window.innerWidth,q=[],u=[];return{init:function(){f();C();c.Lang.isValue(Static.SQUARESPACE_CONTEXT.authenticatedAccount)&&D()},destroy:function(){q=q.filter(function(a){a.detach();return!1});u=u.filter(function(a){"function"===typeof a.destroy&&a.destroy();return!1});k&&(k.get("container")&&k.get("container").hide(),"function"===typeof k.destroy&&k.destroy());m&&(m.get("container")&&
m.get("container").hide(),"function"===typeof m.destroy&&m.destroy())}}},n;p.Squarespace.onInitialize(c,function(){r.querySelector(".sqs-gallery-list")&&(n=new s,n.init())});p.Squarespace.onDestroy(c,function(){n&&(n.destroy&&"function"===typeof n.destroy&&n.destroy(),n=null)})},"1.0",{requires:"base node squarespace-dom-emitters-resize squarespace-gallery-ng squarespace-image-loader squarespace-public-api".split(" ")})}});
