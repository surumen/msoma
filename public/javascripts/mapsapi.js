...
(function() {
    ...
    google.maps.Load = function(apiLoad) {
        ...
        apiLoad([0.009999999776482582, [null, [
                    ["https://khms0.googleapis.com/kh?v=718\u0026hl=en-US\u0026", "https://khms1.googleapis.com/kh?v=718\u0026hl=en-US\u0026"], null, null, null, 1, "718", ["https://khms0.google.com/kh?v=718\u0026hl=en-US\u0026", "https://khms1.google.com/kh?v=718\u0026hl=en-US\u0026"]
                ], null, null, null, null, [
            ...
            ["https://maps.googleapis.com/maps-api-v3/api/js/27/12", "3.27.12"],
            [3049988972], 1, null, null, [3, 8, 11, 13, 14, 17, 20, 21, 24, 26, 55, 19, 81], null, null, "GoogleMapsApiLoadCallback", ["places"], null, 1, "https://khms.googleapis.com/mz?v=718\u0026", "AIzaSyBQdch5IcgcQaKNG76sbMQv1MEBEKLeQ-8", "https://earthbuilder.googleapis.com", "https://earthbuilder.googleapis.com", null, "https://mts.googleapis.com/maps/vt/icon", [
                ["https://maps.googleapis.com/maps/vt"],
                ["https://maps.googleapis.com/maps/vt"], null, null, null, null, null, null, null, null, null, null, ["https://www.google.com/maps/vt"], "/maps/vt", 375000000, 375
            ...
            ["https://www.google.com/maps/api/js/master?pb=!1m2!1u27!2s12!2sen-US!3sUS!4s27/12", "https://www.google.com/maps/api/js/widget?pb=!1m2!1u27!2s12!2sen-US"], null, 0, null, "/maps/api/js/ApplicationService.GetEntityDetails", 0, null, null, null, null, [],
            ["27.12"]
        ], loadScriptTime);
    };
...
google.maps.__gjsload__('places', function(_) {
    var ex = function(a, b) {
            try {
                _.hd(window.HTMLInputElement, "HTMLInputElement")(a)
            } catch (c) {
                if (_.$c(c), !a) return
            }
    ...
    _.t(ex, _.A);
    ex.prototype.setTypes = _.Ld("types", _.jd(_.hi));
    ex.prototype.setComponentRestrictions = _.Ld("componentRestrictions", _.dd({
        country: _.ld([_.hi, _.jd(_.hi)])
    }, !0));
    _.Md(ex.prototype, {
        place: null,
        bounds: _.nd(_.ae)
    });
    gx.prototype.getPlacePredictions = function(a, b) {
        _.G("places_impl", (0, _.p)(function() {
            this.b.getPlacePredictions(a, b)
        }, this))
    };
    gx.prototype.getPredictions = gx.prototype.getPlacePredictions;
    gx.prototype.getQueryPredictions = function(a, b) {
        _.G("places_impl", (0, _.p)(function() {
    ...
    _.k.search = hx.prototype.nearbySearch;
