webpackJsonp([20], {
    ...
    13: function(g, b, a) {
        b.__esModule = !0;
        g = a(16);
        b.default = (g && g.__esModule ? g : {
            "default": g
        }).default || function(a) {
            for (var b = 1; b < arguments.length; b++) {
                var h = arguments[b],
                    c;
                for (c in h) Object.prototype.hasOwnProperty.call(h, c) && (a[c] = h[c])
            }
            return a
        }
    },
    ...
    44: function(g, b, a) {
        var k = (b = a(4)) && b.__esModule ? b : {
                "default": b
            },
            e = (b = a(7)) && b.__esModule ? b : {
                "default": b
            };
        a = a(9);
        b = function() {
    ...
    50: function(g, b, a) {
        ...
        a = a(77);
        var c = k(a);
        b.default = function(a, d) {
            if ("function" !== typeof d && null !== d) throw new TypeError("Super expression must either be null or a function, not " + ("undefined" === typeof d ? "undefined" : (0, c.default)(d)));
            a.prototype = (0, h.default)(d && d.prototype, {
                constructor: {
                    value: a,
                    enumerable: !1,
                    writable: !0,
    ...
    51: function(g, b, a) {
        b.__esModule = !0;
        var k = (g = a(77)) && g.__esModule ?
            g : {
                "default": g
            };
        b.default = function(a, b) {
            if (!a) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
            return b && ("object" === ("undefined" === typeof b ? "undefined" : (0, k.default)(b)) || "function" === typeof b) ? b : a
        }
    },
    52: function(g, b, a) {
    ...
    56: function(g, b) {
        ...
        g.exports = function(b, e) {
            ...
            e = a(void 0 === e ? b.length - 1 : +e || 0, 0);
            return function() {
                for (var h = arguments, c = -1, f = a(h.length - e, 0), d = Array(f); ++c < f;) d[c] = h[e + c];
                switch (e) {
                    case 0:
                        return b.call(this, d);
                    case 1:
                        return b.call(this, h[0], d);
                    case 2:
                        return b.call(this, h[0], h[1], d)
                }
                f = Array(e + 1);
                for (c = -1; ++c < e;) f[c] = h[c];
                f[e] = d;
    ...
    65: function(g, b, a) {
        function k(a, m, b, s) {
            s || (s = []);
            for (var q = -1, n = a.length; ++q < n;) {
                var g = a[q];
                d(g) && f(g) && (b || c(g) || h(g)) ? m ? k(g, m, b, s) : e(s, g) : b || (s[s.length] = g)
            }
            return s
        }
        var e = a(352),
    ...
    76: function(g, b, a) {
        var k = a(65),
            ...
            c = a(245);
        b = a(56)(function(a, d) {
            return null == a ? {} : "function" == typeof d[0] ? c(a, e(d[0], d[1], 3)) : h(a, k(d))
        });
        g.exports = b
    },
    88: function(g, b, a) {
        ...
        g.exports = function(a, f) {
            var d = (e.Object || {})[a] || Object[a],
                b = {};
            b[a] = f(d);
            k(k.S + k.F * h(function() {
                d(1)
            }), "Object", b)
        }
    },
    95: function(g, b, a) {
        ...
        a = function() {
            function a() {
                ...
                value: function(a) {
                    this.setState(new d(a.websiteSettings))
                }
            }, {
                key: "onUpdate",
                value: function(a) {
                ...
                key: "save",
                value: function(a) {
                    a = this.getState().mergeDeep(a).toJS();
                    return f.save(a)
                }
            }]);
            return a
        }();
        g.exports = b.createStore(h(a), "WebsiteSettingsStore")
    },
    99: function(g, b, a) {
        function k(a) {
        ...
        var l = a(776),
            ...
            q = a(568);
        a = a(1051);
        var n = a.DEFAULT_COLLECTION_CONFIGURATIONS,
            u = a.DEFAULT_COLLECTION_CONFIGURATION,
            t = a.DEFAULT_TEMPLATE_PAGE_CONFIGURATION;
        a = function() {
            function a() {
                (0, c.default)(this, a);
                this.bindListeners({
                    handleLoadTemplate: r.LOAD_TEMPLATE,
                    staticInitialized: m.BOOTSTRAP
                });
                this.exportPublicMethods({
                ...
                value: function(a) {
                    this.waitFor(l.dispatchToken);
                    a.error ? this.error = a.response : (this.error = null, this.setTemplateData(a.template),
                        this.demoCollections = this.processDemoCollections(a.demoCollections))
                }
            }, {
                key: "setTemplateData",
                value: function(a) {
                    a && (this.id = a.id, this.name = a.name, this.updatedOn = a.updatedOn, this.ownerWebsiteId = a.ownerWebsiteId, this.collectionConfigs = this.processCollectionConfigs(a.collectionConfigs), this.pageConfigs = this.processPageConfigs(a.pageConfigs), this.customTypes = this.processCustomTypes(a.customTypes), this.layouts = this.processLayouts(a.layouts), this.navigations = a.navigations)
                }
            }, {
                key: "processCollectionConfigs",
                value: function(a) {
                    a.products && (a.products = (0, h.default)({}, n.products, a.products), a.products.acceptTypes && 0 === a.products.acceptTypes.length && (a.products.acceptTypes = n.products.acceptTypes), a.products.ordering = s.USER);
                    a.page && (a.page = (0, h.default)({}, n.page, a.page));
                    a = (0, h.default)({}, n, a);
                    a = d(a, function(a) {
                        a = (0, h.default)({}, u, a);
                        !0 === a.index ? a.folderBehavior = q.INDEX : !0 === a.folder && (a.folderBehavior = q.NONE);
                        return a
                    });
                    var c = a.folders || a.folder;
                    c && (c.acceptTypes = this.calculateFolderAcceptTypes(a));
                    return a
                }
            }, {
                key: "calculateFolderAcceptTypes",
                value: function(a) {
                    var d = ["subscription", "gallery-block", "template-page"];
                    return (0, e.default)(a).filter(function(c) {
                        return a[c].folder ? !1 : -1 === d.indexOf(c)
                    }).concat(["link"])
                }
            }, {
                ...
                value: function(a) {
                    return d(a, function(a) {
                        return (0, h.default)({}, t, a)
                    })
                }
            }, {
                key: "processCustomTypes",
                value: function() {
                    return (0 >= arguments.length || void 0 === arguments[0] ? [] : arguments[0]).reduce(function(a, d) {
                        a[d.name] = d;
                        return a
                    }, {})
                }
    ...
    140: function(g, b, a) {
        ...
        a = function() {
            function a() {
                ...
                value: function(a) {
                    var c = this,
                        d = 1 >= arguments.length || void 0 === arguments[1] ? !1 : arguments[1],
                        b = arguments[2];
                    this.dispatch(a);
                    return f.read(a, d, b).then(function(a) {
                        return c.actions.insert(a.data)
                    }).catch(function(a) {
                        a = a.data;
                        return e.default.reject(a.message || a)
                    })
                }
            }, {
                ...
                value: function(a) {
                    var c = this;
                    this.dispatch(a);
                    return f.readForCollection(a).then(function(a) {
                        (a = a.data) && a.results.forEach(function(a) {
                            return c.actions.insert(a)
                        });
                        return e.default.resolve(a)
                    }).catch(function(a) {
                        a = a.data;
                        return e.default.reject(a.message || a)
                    })
                ...
                value: function(a, c) {
                    var d = this;
                    this.dispatch(a.id);
                    return a.field ? f.updateField(a).then(function(a) {
                        return d.actions.insert(a.data.item)
                    }).catch(function(a) {
                        a = a.data;
                        return e.default.reject(a.message || a)
                    }) : f.update(a, c).then(function(a) {
                        a = a.data;
                        d.actions.insert(a);
                        return a
                    }).catch(function(a) {
                ...
                value: function(a, c) {
                    var d = this;
                    return f.updateForCollection(a, c).then(function(a) {
                        return d.actions.insert(a.data)
                    }).catch(function(a) {
                        a = a.data;
                        return e.default.reject(a.message || a)
                    })
                ...
                value: function(a, c, d) {
                    var b = this;
                    return f.create(a, c, d).then(function(a) {
                        a = a.data;
                        b.actions.insert(a);
                        return a
                    }).catch(function(a) {
                ...
                value: function(a, c, d) {
                    var b = this;
                    return f.createForCollection(a, c, d).then(function(a) {
                        a = a.data;
                        b.actions.insert(a);
                        return a
                    }).catch(function(a) {
                ...
                value: function(a, c) {
                    this.dispatch(a);
                    return f.delete(a, c).catch(function(a) {
                        a =
                            a.data;
                        return e.default.reject(a.message || a)
                    })
    ...
    145: function(g, b, a) {
        var k = a(771),
            ...
            c = a(27),
            f = a(39);
        g.exports = function(a, b, m) {
            var r = c(a) ? k : h;
            m && f(a, b, m) && (b = void 0);
            if ("function" != typeof b || void 0 !== m) b = e(b, m, 3);
            return r(a, b)
        }
    },
    157: function(g, b, a) {
        ...
        var m = function() {
            function a() {
                ...
                key: "onInsert",
                value: function(a) {
                    this.setState(this.state.set(a.id, d(a)))
                }
            }, {
                key: "onDelete",
                value: function(a) {
                ...
                key: "onDeleteMany",
                value: function(a) {
                    this.setState(this.state.filter(function(c,
                        d) {
                ...
                value: function(a) {
                    var c = this,
                        d = 1 >= arguments.length || void 0 === arguments[1] ? !1 : arguments[1],
                        f = arguments[2];
                    if (!a) return e.default.resolve();
                    var b = this.getState().get(a);
                    return b ? e.default.resolve(b) : l.read(a, d, f).then(function() {
                        return c.getState().get(a)
                    })
                }
            }, {
                ...
                value: function(a) {
                    var c = this,
                        d = this.getForCollection(a);
                    return 0 < d.size ? e.default.resolve(d) : l.readForCollection(a).then(function() {
                        return c.getForCollection(a)
                    })
                }
            }, {
                key: "getForCollection",
                value: function(a) {
                    return this.getState().filter(function(c) {
                        return c.get("collectionId") === a
                    })
                }
            }]);
            return a
        }();
        g.exports = b.createStore(a(m), "ContentItemStore")
    },
    158: function(g, b, a) {
        b.__esModule = !0;
        var k = (g = a(46)) && g.__esModule ? g : {
                "default": g
            },
            e = (a = a(306)) && a.__esModule ? a : {
                "default": a
            };
        b.default = function c(a, d, b) {
            null === a && (a = Function.prototype);
            var m = (0, e.default)(a, d);
            if (void 0 === m) return a = (0, k.default)(a), null === a ? void 0 : c(a, d, b);
            if ("value" in m) return m.value;
            d = m.get;
            return void 0 === d ? void 0 : d.call(b)
        }
    },
    162: function(g, b) {
        g.exports = {
    ...
    164: function(g, b, a) {
        function k(a) {
            return {
                url: F[a.action].replace("{collectionId}",
                    a.collectionId),
                isFallback: !0
            }
        }
        ...
        function e(a) {
            return {
                url: G[a.collectionType][a.action].replace("{collectionId}", a.collectionId).replace("{parentId}", a.parentId),
                isFallback: !1
            }
        }
        ...
        function h() {
            ...
            if (a.parentId) return a.collectionType === w.PRODUCTS ? e(a) : k(a);
            var c = I[a.collectionOrdering];
            if (!c) return k(a);
            c = c[a.recordType];
            return !c ? k(a) : {
                url: c[a.action].replace("{collectionId}", a.collectionId),
                isFallback: !1
            }
        }
        var c = (b = a(13)) && b.__esModule ? b : {
                "default": b
            },
            f, d, l, m, r, s, q, n, u, t, A, B, D, C, z, x, y, p = a(173),
            v = a(96);
        b = a(163);
        var w = a(36),
            I = (u = {}, u[b.CHRONOLOGICAL] = (m = {}, m[v.TEXT] = (f = {}, f[p.GET] = "/api/content/blogs/{collectionId}/text-posts/{id}", f[p.POST] = "/api/content/blogs/{collectionId}/text-posts", f[p.PUT] = "/api/content/blogs/{collectionId}/text-posts/{id}", f[p.DELETE] = "/api/content/blogs/{collectionId}/text-posts/{id}", f), m[v.IMAGE] = (d = {}, d[p.GET] = "/api/content/blogs/{collectionId}/image-posts/{id}",
                ...
                q), n), u),
            G = (A = {}, A[w.PRODUCTS] = (t = {}, t[p.GET] = "/api/content/product-pages/{collectionId}/products/{parentId}/images/{id}", t[p.POST] = "/api/content/product-pages/{collectionId}/products/{parentId}/images", t[p.PUT] = "/api/content/product-pages/{collectionId}/products/{parentId}/images/{id}", t[p.DELETE] = "/api/content/product-pages/{collectionId}/products/{parentId}/images/{id}", t), A),
            E = (z = {}, z[b.CHRONOLOGICAL] = (B = {}, B[w.COLLECTION_TYPE_GENERIC] = "/api/content/blogs/{collectionId}/posts", B), z[b.CALENDAR] =
                (D = {}, D[w.COLLECTION_TYPE_GENERIC] = "/api/content/calendars/{collectionId}/events", D), z[b.USER] = (C = {}, C[w.PRODUCTS] = "/api/content/product-pages/{collectionId}/products", C), z),
            F = (x = {}, x[p.GET] = "/api/content-collections/{collectionId}/content-items/{id}", x[p.POST] = "/api/content-collections/{collectionId}/content-items", x[p.PUT] = "/api/content-collections/{collectionId}/content-items/{id}", x[p.DELETE] = "/api/content-collections/{collectionId}/content-items/{id}", x),
            H = (y = {}, y[p.GET] = "/api/content-items/{id}",
                y[p.POST] = "/api/content-items", y[p.PUT] = "/api/content-items/{id}", y[p.DELETE] = "/api/content-items/{id}", y);
        g.exports = {
            getTemplateForSingleItem: function() {
                return h(0 >= arguments.length || void 0 === arguments[0] ? {} : arguments[0]).url
            },
            getTemplateForCollectionItems: function(a, c) {
                if (!a) return "/api/content-collections/{collectionId}/content-items";
                var d = void 0;
                E.hasOwnProperty(a) && (d = E[a][c]);
                return !d ? "/api/content-collections/{collectionId}/content-items" : d
            },
            ...
            getChildImageUploadUrl: function() {
                var a = 0 >= arguments.length || void 0 === arguments[0] ? {} : arguments[0];
                return a.recordType === v.STORE_ITEM ?
                    e({
                        collectionType: w.PRODUCTS,
                        recordType: v.STORE_ITEM,
                        action: p.POST,
                        parentId: a.parentId,
    ...
    230: function(g, b, a) {
        ...
        g.exports = function(a) {
            return "number" == typeof a || k(a) && "[object Number]" == e.call(a)
        }
    },
    235: function(g, b, a) {
        g.exports = {
        ...
        a = function() {
            function a() {
                ...
                value: function(a) {
                    ...
                    return q(a) ? (this.setState(h(a)), !0) : !1
                }
            }, {
                key: "hasPermission",
                value: function(a) {
                    var c = this.getState(),
                        d = "string" === typeof a ? l[a] : a;
                    if (void 0 === d) throw Error(a ? "Permission '" + a + "' not found." : "Permission is undefined.");
                    return c.has(d)
                }
            }, {
                key: "hasAllPermissions",
                value: function(a) {
                    return c(a, this.hasPermission, this)
                }
            }, {
                key: "hasAnyPermission",
                value: function(a) {
                    return f(a, this.hasPermission, this)
                }
            }, {
                key: "isAdmin",
                value: function() {
                    return this.hasPermission(l.ADMIN)
                }
            }]);
            return a
        }();
        g.exports = b.createStore(d(a), "AccessPermissionStore")
    },
    291: function(g, b, a) {
        var k = (b =
                a(4)) && b.__esModule ? b : {
        ...
        a = function() {
            function a() {
                ...
                value: function(a) {
                    var c = this;
                    h.getTemplate(a).then(function(a) {
                        c.dispatch(a.data)
                    }, function(a) {
                        c.dispatch({
                            error: !0,
    ...
    295: function(g, b, a) {
        ...
        g.exports = function(a) {
            var d = {};
            (0, c.default)(a).map(function(c) {
                var b = a[c];
                "object" === ("undefined" === typeof b ? "undefined" : (0, h.default)(b)) ? d[c] = (0, e.default)(b): void 0 !== b && (d[c] = b)
            });
            return d
        }
    },
        ...
        a = function() {
            function a() {
                ...
                value: function() {
                    var a = this;
                    this.dispatch();
                    return d.loadTemplateInstallations().then(function(c) {
                            a.actions.loadSuccess(c.data)
                        },
                        function(c) {
                            a.actions.loadFailure(c.error)
                        })
                }
            }, {
                ...
                value: function(a, c, d) {
                    var b = this,
                        t = (0, e.default)({}, a, {
                            previewInstallationId: c
                        });
                    f.save(a.id, t).then(function(a) {
                        m.loadTemplate.defer(d);
                        b.dispatch(c);
                        setTimeout(function() {
                            return l.setUrl("/")
                        }, 1E3)
                ...
                value: function(a, c) {
                    var b = this;
                    d.setLiveInstallation(a).then(function(d) {
                        m.loadTemplate.defer(c);
                        b.dispatch(a);
                        setTimeout(l.refresh, 1E3)
                    }, function(a) {})
                }
            }, {
                ...
                value: function(a) {
                    var c = this;
                    return d.setHomepageCollectionId(a).then(function(d) {
                        d = {
                ...
                value: function(a) {
                    return d.updateInstallation(a).then(this.actions.loadAll)
                }
            }, {
                key: "loadSuccess",
                value: function(a) {
    ...
    309: function(g, b, a) {
        ...
        var k = a(31).Object;
        g.exports = function(a, b) {
            return k.getOwnPropertyDescriptor(a, b)
        }
    },
    310: function(g, b, a) {
        a(316);
    ...
    313: function(g, b, a) {
        var k = a(134),
            ...
            h = function(a, b) {
                e(a);
                if (!k(b) && null !== b) throw TypeError(b + ": can't set as prototype!");
            };
        g.exports = {
            set: Object.setPrototypeOf || ("__proto__" in {} ? function(c, b, d) {
                try {
                    d = a(220)(Function.call, a(250).f(Object.prototype, "__proto__").set, 2), d(c, []), b = !(c instanceof Array)
                } catch (e) {
                    b = !0
                }
                return function(a, c) {
    ...
    337: function(g, b, a) {
        ...
        a = function() {
            function a() {
                ...
                value: function(a) {
                    var c = this;
                    return h.put("/api/settings", a).then(function(a) {
                        return c.actions.update(a.data)
                    })
                }
            }]);
            return a
    ...
    338: function(g, b, a) {
        ...
        a = function() {
            function a() {
                ...
                this.bindListeners({
                    handleLoadSuccess: c.LOAD_SUCCESS,
                    handleLoadFailure: c.LOAD_FAILURE,
                    handleStaticInitialized: h.BOOTSTRAP,
                    handlePreviewSet: c.SET_PREVIEW_INSTALLATION,
                    handleTemplateSet: c.SET_LIVE_INSTALLATION,
                    handleHomepageCollectionIdSet: c.SET_HOMEPAGE_COLLECTION_ID
                });
                this.exportPublicMethods({
                ...
                value: function() {
                    return this.getState().activeInstallation ? this.getState().activeInstallation.homepageCollectionId : this.getState().homepageCollectionId
                }
            }, {
                ...
                value: function(a) {
                    ...
                    this.previewInstallationId = c ? c.previewInstallationId : null;
                ...
                value: function(a) {
                    a.error || (this.homepageCollectionId = a.homepageCollectionId, this.activeInstallation && (this.activeInstallation.homepageCollectionId =
                        a.homepageCollectionId))
                }
            }, {
                ...
                value: function(a) {
                    ...
                    this.maintainMissingInstallation(c, this.liveInstallationId);
                    this.maintainMissingInstallation(c, this.previewInstallationId);
                    this.templateInstallations =
                        c;
                    this.updateInstallationReferences()
                }
                ...
                value: function(a, c) {
                    c && !a[c] && (a[c] = this.templateInstallations[c])
                }
            }, {
    ...
    352: function(g, b) {
        g.exports = function(a, b) {
            for (var e = -1, h = b.length, c = a.length; ++e < h;) a[c + e] = b[e];
            return a
        }
    },
    434: function(g, b, a) {
        function k(a) {
            ...
            return d.getTemplateForSingleItem((0, e.default)({}, c, {
                action: a
            })).replace("{id}", b)
        }
        var e = (b = a(13)) && b.__esModule ? b : {
                "default": b
            },
            h = a(143),
            c = a(25),
        ...
        g.exports = {
            read: function(a) {
                var d = arguments[2];
                return (1 >= arguments.length || void 0 === arguments[1] ? 0 : arguments[1]) ? c.get("/api/rest/global-content-items/" + a) : c.get(k(l.GET, d, a))
            },
            readForCollection: function(a, b) {
                var f = d.getTemplateForCollectionItems(b).replace("{collectionId}",
                    a);
                return c.get(f)
            },
            update: function(a, d) {
                ...
                return c.put(k(l.PUT, d, a.id), a)
            },
            updateForCollection: function(a, d) {
                delete a.author;
                delete a.pendingPushedServices;
                delete a.pushedServices;
                return c.put(k(l.PUT, d, a.id), a)
            ...
            create: function(a, d, b) {
                return c.post(k(l.POST, b), a, d)
            },
            createForCollection: function(a, d, b) {
                return c.post(k(l.POST, b), a, d)
            },
            updateField: function(a) {
                a = f(a);
                return c.post("/api/commondata/SaveItemField", h.stringify(a))
            },
            "delete": function(a,
                d) {
                return c.delete(k(l.DELETE, d, a))
            },
            deleteMany: function(a) {
                a = h.stringify({
                    items: a
                });
                return c.post("/api/commondata/RemoveItems", a, {
                    headers: {
    ...
    524: function(g, b) {
        YUI.add("model", function(a, b) {
            ...
            var h = YUI.namespace("Env.Model"),
                c = a.Lang,
                f = a.Array,
                d = a.Object,
                l = "error";
            a.Model = a.extend(e, a.Base, {
                idAttribute: "id",
                _allowAdHocAttrs: !0,
                _isYUIModel: !0,
                ...
                destroy: function(a, c) {
                    ...
                    d.onceAfter("destroy", function() {
                        function b(n) {
                            n || f.each(d.lists.concat(),
                                function(c) {
                                    c.remove(d, a)
                                });
                            c && c.apply(null, arguments)
                        }
                        a && (a.remove || a["delete"]) ? d.sync("delete", a, b) : b()
                    });
                    return e.superclass.destroy.call(d)
                },
                generateClientId: function() {
                    h.lastId || (h.lastId = 0);
                    return this.constructor.NAME + "_" + (h.lastId += 1)
                },
                getAsHTML: function(d) {
                    d = this.get(d);
                    return a.Escape.html(c.isValue(d) ? String(d) : "")
                },
                getAsURL: function(a) {
                    a = this.get(a);
                    return encodeURIComponent(c.isValue(a) ? String(a) : "")
                },
                isModified: function() {
                    return this.isNew() || !d.isEmpty(this.changed)
                },
                isNew: function() {
                    return !c.isValue(this.get("id"))
                },
                load: function(a, c) {
                    var d = this;
                    "function" === typeof a && (c = a, a = {});
                    a || (a = {});
                    d.sync("read", a, function(b, f) {
                        var e = {
                                options: a,
                                response: f
                            },
                            t;
                        b ? (e.error = b, e.src = "load", d.fire(l, e)) : (d._loadEvent || (d._loadEvent = d.publish("load", {
                            preventable: !1
                        })), t = e.parsed = d._parse(f), d.setAttrs(t, a), d.changed = {}, d.fire("load", e));
                        c && c.apply(null, arguments)
                    });
                    return d
                },
                ...
                save: function(a,
                    ...
                    "function" === typeof a && (c = a, a = {});
                    a || (a = {});
                    d._validate(d.toJSON(), function(b) {
                        b ? c && c.call(null, b) : d.sync(d.isNew() ? "create" : "update", a, function(b, f) {
                            var e = {
                                    options: a,
                                    response: f
                                },
                                h;
                            b ? (e.error = b, e.src = "save", d.fire(l, e)) : (d._saveEvent || (d._saveEvent = d.publish("save", {
                                preventable: !1
                            })), f && (h = e.parsed = d._parse(f), d.setAttrs(h, a)), d.changed = {}, d.fire("save", e));
                            c && c.apply(null, arguments)
                        })
                    });
                    return d
                ...
                set: function(a, c, d) {
                    var b = {};
                    b[a] = c;
                    return this.setAttrs(b, d)
                },
                setAttrs: function(c, b) {
                    var f =
                        this.idAttribute,
                        e, n, h, t;
                    b = a.merge(b);
                    t = b._transaction = {};
                    "id" !== f && (c = a.merge(c), d.owns(c, f) ? c.id = c[f] : d.owns(c, "id") && (c[f] = c.id));
                    for (n in c) d.owns(c, n) && this._setAttr(n, c[n], b);
                    if (!d.isEmpty(t)) {
                        f = this.changed;
                        h = this.lastChange = {};
                        for (n in t) d.owns(t, n) && (e = t[n], f[n] = e.newVal, h[n] = {
                            newVal: e.newVal,
                            prevVal: e.prevVal,
                            src: e.src || null
                        });
                        b.silent || (this._changeEvent || (this._changeEvent = this.publish("change", {
                            preventable: !1
                        })), b.changed = h, this.fire("change", b))
                    }
                    return this
                },
                sync: function() {
                ...
                undo: function(a, c) {
                    var b = this.lastChange,
                        e = this.idAttribute,
                        n = {},
                        h;
                    a || (a = d.keys(b));
                    f.each(a, function(a) {
                        d.owns(b, a) && (a = a === e ? "id" : a, h = !0, n[a] = b[a].prevVal)
                    });
                    return h ? this.setAttrs(n, c) : this
                },
                validate: function(a, c) {
                    c && c()
                },
                addAttr: function(a, d, b) {
                    var f = this.idAttribute,
                        n;
                    f && a === f && (f = this._isLazyAttr("id") || this._getAttrCfg("id"),
                        n = d.value === d.defaultValue ? null : d.value, c.isValue(n) || (n = f.value === f.defaultValue ? null : f.value, c.isValue(n) || (n = c.isValue(d.defaultValue) ? d.defaultValue : f.defaultValue)), d.value = n, f.value !== n && (f.value = n, this._isLazyAttr("id") ? this._state.add("id", "lazy", f) : this._state.add("id", "value", n)));
                    return e.superclass.addAttr.apply(this, arguments)
                },
                _parse: function(a) {
                    return this.parse(a)
                },
                _validate: function(a, d) {
                    ...
                    var f = this;
                    1 === f.validate.length ? b(f.validate(a, b)) : f.validate(a, b)
                },
                _setAttrVal: function(a, c, d, b, f, h) {
                    var t = e.superclass._setAttrVal.apply(this, arguments),
                        l = f && f._transaction,
                        k = h && h.initializing;
                    t && (l && !k) && (l[a] = {
                        newVal: this.get(a),
    ...
    531: function(g, b) {
        ...
        a.prototype.addActionListener = function(a, b) {
            var h = this.dispatcher.register(function(c) {
                a === c.action && b(c.data, c.details)
            });
            this.listeners[h] = !0;
            return h
        };
        a.prototype.removeActionListener = function(a) {
            delete this.listeners[a];
            this.dispatcher.unregister(a)
        };
        a.prototype.removeAllActionListeners = function() {
    ...
    536: function(g, b, a) {
        ...
        a = {
            ...
            markdownMode: void 0,
            mobileInfoBarSettings: q(),
            notFoundPageId: null,
            ownerId: void 0,
            pinterestOverlayOptions: q(),
        ...
        g.exports = function(a) {
            function b() {
                ...
                (0, h.default)(this,
                    b);
                return (0, f.default)(this, (0, e.default)(b).call(this, m.fromJS(u(a))))
            }(0, l.default)(b, a);
            (0, c.default)(b, [{
                key: "merge",
                value: function(a) {
                    a = a instanceof r ? a : n(u(a), t);
                    return (0, d.default)((0, e.default)(b.prototype), "merge", this).call(this, a)
                }
            }, {
                ...
                value: function() {
                    ...
                    c && (a.tutorialsCompleted = c.reduce(function(a, c) {
                        a[c] = !0;
                        return a
                    }, {}));
                    return a
    ...
    537: function(g,
        b, a) {
        var k = (b = a(19)) && b.__esModule ? b : {
                "default": b
            },
            e = (b = a(16)) && b.__esModule ? b : {
                "default": b
            },
            h = a(26).Set;
        g.exports = function(a) {
            var b = a.notFoundPageId,
                d = a.tutorialsCompleted;
            a = (0, e.default)({}, a);
            d && (a.tutorialsCompleted = h((0, k.default)(d)));
        ...
        b = function() {
            function a() {
                ...
                value: function(a) {
                    var c = this;
                    this.dispatch(a);
                    return f.create(a).then(function(a) {
                        a = a.data;
                        c.actions.insert(a);
                        return a.id
                    })
                ...
                value: function(a) {
                    var c = this;
                    this.dispatch(a);
                    return f.read(a).then(function(a) {
                        return c.actions.insert(a.data)
                    })
                }
            }, {
                ...
                value: function() {
                    var a = this;
                    return f.readAll().then(function(c) {
                        return a.actions.insertMany(c.data)
                    }).catch(function(a) {
                        return e.default.reject(a.data.message)
                    })
                }
            }, {
                key: "delete",
                value: function(a) {
                    var c = this;
                    this.dispatch(a);
                    return f.delete(a).then(function(d) {
                        c.actions.deleteSuccess(a);
                        return d
                    }, function(d) {
                        d = d.data;
                        c.actions.deleteFailure(a, d);
                        return e.default.reject(d.message)
                    })
                }
            }, {
                ...
                value: function(a) {
                    var c = this;
                    this.dispatch(a);
                    return f.deleteUnusedPageCollectionPermanently(a).then(function(d) {
                        c.actions.deleteSuccess(a);
                        return d
                    }, function(d) {
                        d = d.data;
                ...
                value: function(a) {
                    var c = this;
                    return a.id && !a.urlId ? f.generateUrl(a).then(function(d) {
                        a.urlId = d.data.urlId;
                        return f.create(a).then(function(a) {
                            c.actions.insert(a.data);
                            return a.data
                        })
                    }).catch(function(a) {
                        return e.default.reject(a.data.message)
    ...
    584: function(g, b, a) {
        ...
        b = function() {
            function a() {
                (0,
                    k.default)(this, a);
                this.generateActions("refresh", "setUrl", "removeLoadHandler", "disableEditing", "enableEditing")
            }(0, e.default)(a, [{
                key: "addLoadHandler",
                value: function(a, b) {
                    this.dispatch({
    ...
    604: function(g, b) {
        YUI.add("squarespace-model-sync-rest", function(a) {
            ...
            b.prototype = {
                sync: function(b, h, c) {
                    a.Lang.isValue(h.timeout) || (h.timeout = 1E7);
                    a.ModelSync.REST.prototype.sync.apply(this, arguments)
                },
                _storeRequest: function(b,
                    h) {
                    this._ioConfigCache[b.id] = a.merge(h, {})
                },
                ...
                _sendSyncIORequest: function(b) {
                    var h = a.ModelSync.REST.prototype._sendSyncIORequest.apply(this, arguments);
                    this._storeRequest(h, b);
                    return h
                },
                _onSyncIOEnd: function(b, h) {
                    this._retrieveAndEvict(b);
                    a.ModelSync.REST.prototype._onSyncIOEnd.apply(this, arguments)
                },
                _onSyncIOSuccess: function(b, h, c) {
                    var f = this._retrieveAndEvict(b),
                        d = {},
                        l = h.responseText;
                    a.Lang.isValue(l) && l.trim() && (d = a.JSON.parse(l));
                    this._isCrumbFailure(d) ? (d = d.crumb, a.ModelSync.REST.CSRF_TOKEN = d, a.Env.CSRF_TOKEN = d, f.headers["X-CSRF-Token"] = d, this._sendSyncIORequest(f)) : a.ModelSync.REST.prototype._onSyncIOSuccess.apply(this, arguments)
                },
                _onSyncIOFailure: function(b, h, c) {
                    if (b = c.callback) {
                        c = {};
                        var f = h.responseText;
                        a.Lang.isValue(f) && f.trim() && (c = a.JSON.parse(f));
                        b({
                            code: h.status,
                            msg: h.statusText,
                            responseJSON: c
    ...
    605: function(g, b) {
        YUI.add("model-list", function(a, b) {
            ...
            var h = a.Attribute.prototype,
                c = a.Lang,
                f = a.Array;
            a.ModelList = a.extend(e, a.Base, {
                model: a.Model,
                _isYUIModelList: !0,
                initializer: function(c) {
                    c || (c = {});
                    var b = this.model = c.model || this.model;
                    "string" === typeof b && ((this.model = a.Object.getValue(a, b.split("."))) || a.error("ModelList: Model class not found: " + b));
                    this.publish("add", {
                ...
                add: function(d, b) {
                    var e = d._isYUIModelList;
                    return e || c.isArray(d) ? f.map(e ? d.toArray() : d, function(c, d) {
                        var f = b || {};
                        "index" in f && (f = a.merge(f, {
                            index: f.index + d
                        }));
                        return this._add(c, f)
                    }, this) : this._add(d, b)
                },
                create: function(c, b, f) {
                    ...
                    "function" === typeof b &&
                        (f = b, b = {});
                    b || (b = {});
                    c._isYUIModel || (c = new this.model(c));
                    e.fire("create", a.merge(b, {
                        model: c
                    }));
                    return c.save(b, function(a) {
                        a || e.add(c, b);
                        f && f.apply(null, arguments)
                    })
                },
                each: function(a, c) {
                    var b = this._items.concat(),
                        f, e, h;
                    f = 0;
                    for (h = b.length; f < h; f++) e = b[f], a.call(c || e, e, f, this);
                    return this
                },
                filter: function(a, c) {
                    var b = [],
                    ...
                    "function" === typeof a && (c = a, a = {});
                    e = 0;
                    for (n = f.length; e < n; ++e) h = f[e], c.call(this, h, e, this) && b.push(h);
                ...
                get: function(a) {
                    return this.attrAdded(a) ? h.get.apply(this, arguments) : this.invoke("get", a)
                },
                getAsHTML: function(c) {
                    return this.attrAdded(c) ? a.Escape.html(h.get.apply(this, arguments)) : this.invoke("getAsHTML", c)
                },
                getAsURL: function(a) {
                    return this.attrAdded(a) ? encodeURIComponent(h.get.apply(this, arguments)) : this.invoke("getAsURL", a)
                },
                ...
                invoke: function(a) {
                    var c = [this._items,
                        a
                    ].concat(f(arguments, 1, !0));
                    return f.invoke.apply(f, c)
                },
                load: function(a, c) {
                    var b = this;
                    "function" === typeof a && (c = a, a = {});
                    a || (a = {});
                    this.sync("read", a, function(f, e) {
                        var h = {
                                options: a,
                                response: e
                            },
                            n;
                        f ? (h.error = f, h.src = "load", b.fire("error", h)) : (b._loadEvent || (b._loadEvent = b.publish("load", {
                            preventable: !1
                        })), n = h.parsed = b._parse(e), b.reset(n, a), b.fire("load", h));
                        c && c.apply(null, arguments)
                    });
                    return this
                },
                map: function(a, c) {
                    return f.map(this._items, a, c)
                },
                parse: function(c) {
                    if ("string" === typeof c) try {
                        return a.JSON.parse(c) || []
                ...
                remove: function(a, b) {
                    var e = a._isYUIModelList;
                    return e || c.isArray(a) ? (a = f.map(e ? a.toArray() : a, function(a) {
                        return c.isNumber(a) ? this.item(a) : a
                    }, this), f.map(a, function(a) {
                ...
                reset: function(c, b) {
                    ...
                    c = c._isYUIModelList ? c.toArray() : f.map(c, function(a) {
                        return a._isYUIModel ? a : new this.model(a)
                    }, this);
                    e.models = c;
                    b.silent ?
                        this._defResetFn(e) : (this.comparator && c.sort(a.bind(this._sort, this)), this.fire("reset", e));
                    return this
                },
                some: function(a, c) {
                    var b = this._items.concat(),
                    ...
                    for (h = b.length; f < h; f++)
                        if (e = b[f], a.call(c || e, e, f, this)) return !0;
                    return !1
                },
                sort: function(c) {
                    ...
                    var b = this._items.concat();
                    c || (c = {});
                    b.sort(a.rbind(this._sort, this, c));
                    b = a.merge(c, {
                        models: b,
                        src: "sort"
                    });
                    c.silent ? this._defResetFn(b) : this.fire("reset", b);
                    return this
                },
                sync: function() {
                    var a = f(arguments, 0, !0).pop();
                    "function" ===
                    typeof a && a()
                },
                toArray: function() {
                ...
                _add: function(b, f) {
                    ...
                    e = b.get("id");
                    if (this._clientIdMap[b.get("clientId")] || c.isValue(e) && this._idMap[e]) this.fire("error", {
                        error: "Model is already in the list.",
                        model: b,
                        src: "add"
                    });
                    else return e = a.merge(f, {
                        index: "index" in f ? f.index : this._findIndex(b),
                        model: b
                    }), f.silent ? this._defAddFn(e) : this.fire("add", e), b
                },
                ...
                _clear: function() {
                    f.each(this._items, this._detachList, this);
                    this._clientIdMap = {};
                    this._idMap = {};
                    this._items = []
                },
                _compare: function(a, c) {
                    return a < c ? -1 : a > c ? 1 : 0
                },
                _detachList: function(a) {
                    var c = f.indexOf(a.lists, this); - 1 < c && (a.lists.splice(c, 1), a.removeTarget(this))
                },
                _findIndex: function(a) {
                    var c = this._items,
                        ...
                        f = 0,
                        e, h;
                    if (!this.comparator || !b) return b;
                    for (h = this.comparator(a); f < b;) e = f + b >> 1, a = c[e], 0 > this._compare(this.comparator(a), h) ? f = e + 1 : b = e;
                    return f
                },
                _parse: function(a) {
                    return this.parse(a)
                },
                _remove: function(b, f) {
                    var e;
                    f || (f = {});
                    c.isNumber(b) ? (e = b, b = this.item(e)) : e = this.indexOf(b);
                    if (-1 === e || !b) this.fire("error", {
                        ...
                        index: e,
                        model: b
                    }), f.silent ? this._defRemoveFn(e) : this.fire("remove", e), b
                },
                _sort: function(a, c, b) {
                    a = this._compare(this.comparator(a), this.comparator(c));
                    return 0 === a ? a : b && b.descending ? -a : a
                },
                ...
                _defRemoveFn: function(a) {
                    ...
                    c.isValue(f) && delete this._idMap[f];
    ...
    606: function(g, b) {
        YUI.add("model-sync-rest", function(a, b) {
            function e() {}
            var h = a.Lang;
            e.CSRF_TOKEN = YUI.Env.CSRF_TOKEN;
            e.EMULATE_HTTP = !1;
            e.HTTP_HEADERS = {
            ...
            e.prototype = {
                ...
                getURL: function(c, b) {
                    var d = this.root,
                        e = this.url;
                    return this._isYUIModelList ? !e ? this.model.prototype.root : this._substituteURL(e, a.merge(this.getAttrs(), b)) : d && ("create" === c || this.isNew()) ? d : !e ? this._joinURL(this.getAsURL("id") || "") : this._substituteURL(e, a.merge(this.getAttrs(), b))
                },
                ...
                sync: function(c, b, d) {
                    b || (b = {});
                    var h = this.getURL(c, b),
                        k = e.HTTP_METHODS[c],
                        g = a.merge(e.HTTP_HEADERS, b.headers),
                        s = b.timeout || e.HTTP_TIMEOUT;
                    b = b.csrfToken || e.CSRF_TOKEN;
                    var q;
                    "POST" === k || "PUT" === k ? q = this.serialize(c) : delete g["Content-Type"];
                    if (e.EMULATE_HTTP && ("PUT" === k || "DELETE" === k)) g["X-HTTP-Method-Override"] = k, k = "POST";
                    if (b && ("POST" === k || "PUT" === k || "DELETE" === k)) g["X-CSRF-Token"] = b;
                ...
                _substituteURL: function(b, f) {
                    if (!b) return "";
                    var d = {};
                    a.Object.each(f, function(a, b) {
                        if (h.isString(a) || h.isNumber(a)) d[b] = encodeURIComponent(a)
                    });
                    return h.sub(b, d)
                },
                _onSyncIOEnd: function(a, b) {},
                _onSyncIOFailure: function(a, b, d) {
                    (a = d.callback) && a({
                        code: b.status,
                        msg: b.statusText
                    }, b)
                },
                _onSyncIOSuccess: function(a, b, d) {
                    (a = d.callback) && a(null, b)
                },
                _onSyncIOStart: function(a, b) {}
            };
            a.namespace("ModelSync").REST = e
        }, "3.17.2", {
            requires: ["model",
                "io-base", "json-stringify"
            ]
        })
    },
    607: function(g, b, a) {
    ...
    766: function(g, b, a) {
        ...
        g.exports = {
            save: function(a, b) {
                return k.put("/api/member-website-settings/" + a, b)
            },
            commerceUpsellShown: function(a) {
                return k.post("/api/member-website-settings/" +
                    a + "/commerce-upsell-shown")
            }
        }
    },
    776: function(g, b, a) {
        ...
        a = function() {
            function a() {
                ...
                this.state = h();
                this.bindListeners({
                    onSiteLayoutReset: [d.bootstrap, l.loadTemplate]
                });
                this.exportPublicMethods({
                    getCollectionLinks: this.getCollectionLinks
                })
            }(0, e.default)(a, [{
        ...
        g.exports = b.createStore(f(a), "SiteNavigationStore")
    },
    777: function(g, b, a) {
        var k = a(143),
            e = a(25),
        ...
        g.exports = {
            generateUrl: function(a) {
                if (a.id) {
                    var b = 3 > a.title.length ? a.typeName + "-" + a.title : a.title,
                        b = c(b);
                    return e.post("/api/content-collections/" +
                        a.id + "/generate-url", {
                            title: a.title,
                            urlId: b
                        })
            ...
            create: function(a) {
                a = h(a);
                a = k.stringify(a);
                return e.post("/api/commondata/SaveCollection", a, {
                    headers: {
            ...
            read: function(a) {
                return e.get("/api/commondata/GetCollection", {
                    params: {
                        collectionId: a
                    }
                })
            ...
            readAll: function() {
                return e.get("/api/commondata/GetCollections")
            },
            "delete": function(a) {
                return e.post("/api/commondata/RemoveCollection", k.stringify({
                    collectionId: a
                }))
            },
            deleteUnusedPageCollectionPermanently: function(a) {
                return e.post("/api/commondata/unused-start-page-collection",
                    k.stringify({
                        collectionId: a
                    }))
            }
            ...
            var e = function(a, b, d) {
                ...
                h = {
                    formats: {
                        ...
                        C: function(a) {
                            return e(parseInt(a.getFullYear() / 100,
                                10), 0)
                        },
                        d: ["getDate", "0"],
                        e: ["getDate", " "],
                        g: function(a) {
                            return e(parseInt(h.formats.G(a) % 100, 10), 0)
                        },
                        G: function(a) {
                            var b = a.getFullYear(),
                                d = parseInt(h.formats.V(a), 10);
                            a = parseInt(h.formats.W(a), 10);
                            a > d ? b++ : 0 === a && 52 <= d && b--;
                            return b
                        },
                        H: ["getHours", "0"],
                        ...
                        U: function(a) {
                            var b = parseInt(h.formats.j(a), 10);
                            a = 6 - a.getDay();
                            b = parseInt((b + a) / 7, 10);
                            return e(b, 0)
                        },
                        V: function(a) {
                            var b = parseInt(h.formats.W(a), 10),
                                d = (new Date("" +
                                    a.getFullYear() + "/1/1")).getDay(),
                                b = b + (4 < d || 1 >= d ? 0 : 1);
                            53 === b && 4 > (new Date("" + a.getFullYear() + "/12/31")).getDay() ? b = 1 : 0 === b && (b = h.formats.V(new Date("" + (a.getFullYear() - 1) + "/12/31")));
                            return e(b, 0)
                        },
                        w: "getDay",
                        W: function(a) {
                        ...
                        y: function(a) {
                            return e(a.getFullYear() % 100, 0)
                        },
                        Y: "getFullYear",
                        z: function(a) {
                            a = a.getTimezoneOffset();
                            var b = e(parseInt(Math.abs(a / 60), 10), 0),
                                d = e(Math.abs(a % 60), 0);
                            return (0 < a ? "-" : "+") + b +
                                d
                        },
                    ...
                    format: function(b, f) {
                        ...
                        for (var g = function(a, b) {
                                var c = h.aggregates[b];
                                return "locale" === c ? k[b] : c
                            }, r = function(d, f) {
                                var n = h.formats[f];
                                switch (a.Lang.type(n)) {
                                    case "string":
                                        return b[n]();
                                    case "function":
                                        return n.call(b, b, k);
                                    case "array":
                                        if ("string" === a.Lang.type(n[0])) return e(b[n[0]](), n[1]);
                                    default:
                                        return f
                                }
                            }; d.match(/%[cDFhnrRtTxX]/);) d = d.replace(/%([cDFhnrRtTxX])/g, g);
                        d = d.replace(/%([aAbBCdegGHIjklmMpPsSuUVwWyYzZ%])/g, r);
                        g = r = void 0;
                        return d
                    }
                };
            a.mix(a.namespace("Date"), h);
        ...
        a = function() {
            function a() {
                ...
                value: function(a, b) {
                    var c = this;
                    this.dispatch();
                    return h.save(a, b).then(function(a) {
                        c.actions.saveSuccess(a)
                    })
                }
            }]);
            return a
    ...
    946: function(g, b, a) {
        ...
        var m = function() {
            function a() {
                ...
                this.bindListeners({
                    onInsert: l.insert,
                    onInsertMany: l.insertMany,
                    onDelete: [l.delete, l.deleteUnusedCollectionPermanently]
                });
                this.exportPublicMethods({
                    fetch: this.fetch,
                ...
                value: function(a) {
                    var b = this.getState().get(a);
                    return b ? e.default.resolve(b) : this.fetchFromServer(a)
                }
            }, {
                key: "fetchFromServer",
                value: function(a) {
                    var b = this;
                    return l.read(a).then(function() {
        ...
        g.exports = b.createStore(a(m), "ContentCollectionStore")
    },
    963: function(g, b, a) {
        var k = a(25);
        g.exports = {
            getTemplate: function(a) {
                return k.get("/api/templates/" +
                    a)
            }
        }
    },
    964: function(g, b, a) {
        ...
        g.exports = {
            loadTemplateInstallations: function() {
                return k.get("/api/template-installations")
            },
            setLiveInstallation: function(a) {
                return k.post("/api/template/SetTemplate", e.stringify({
                    installationId: a
                }))
            },
            updateInstallation: function(a) {
                return k.put("/api/template-installations/" + a.id, a)
            },
            setHomepageCollectionId: function(a) {
                return k.post("/api/template/SetHomepageCollection", e.stringify({
                    collectionId: a
                }))
            }
        }
    ...
    1016: function(g, b) {
        YUI.add("datatype-date-math", function(a, b) {
            var e = a.Lang;
            a.mix(a.namespace("Date"), {
                isValidDate: function(a) {
                    return e.isDate(a) && isFinite(a) && "Invalid Date" != a && !isNaN(a) && null != a ? !0 : !1
                },
                areEqual: function(a,
                    b) {
                ...
                isInRange: function(a, b, e) {
                    return this.isGreaterOrEqual(a, b) && this.isGreaterOrEqual(e, a)
                },
                ...
                listOfDatesInMonth: function(a) {
                    ...
                    var b = this.daysInMonth(a),
                        e = a.getFullYear();
                    a = a.getMonth();
                    for (var d = [], k = 1; k <= b; k++) d.push(new Date(e, a, k, 12, 0, 0));
                    return d
                },
    ...
    1051: function(g, b, a) {
        ...
        g.exports = {
            DEFAULT_COLLECTION_CONFIGURATIONS: {
                page: {
                    collectionType: k.COLLECTION_TYPE_PAGE,
                    typeName: "page",
                    title: "Page",
                    ordering: b.CUSTOM,
                    icon: "page",
                ...
                "gallery-block": {
                    collectionType: k.GALLERY_BLOCK,
                ...
                "template-page": {
                    collectionType: k.TEMPLATE_PAGE,
                    title: "Template Page",
                    icon: "projects"
                },
                "splash-page": {
                    collectionType: k.SPLASH_PAGE,
                ...
                subscription: {
                    collectionType: k.COLLECTION_TYPE_SUBSCRIPTION,
            ...
            DEFAULT_COLLECTION_CONFIGURATION: {
                collectionType: k.COLLECTION_TYPE_GENERIC,
                supported: !0,
        ...
        var l = h.Map,
            m = function() {
                function a() {
                    ...
                    this.state = l();
                    this.bindListeners({
                        onUpdateAttributes: c.updateAttributes,
                        unstageChanges: [f.insert, f.delete, c.reset]
                    });
                    this.exportPublicMethods({
                        fetchStaged: this.fetchStaged,
                        getItemDirtyState: this.getItemDirtyState,
                        getItemState: this.getItemState,
                        unstageChanges: this.unstageChanges
                    })
                }(0, e.default)(a, [{
                    key: "onUpdateAttributes",
                    value: function(a) {
                        var b = h.fromJS(a.attrs),
                            c = this.state.get(a.itemId);
                        c && (b = c.merge(a.attrs));
                        this.setState(this.state.set(a.itemId, b))
                    }
                }, {
                    key: "unstageChanges",
                    value: function(a) {
                        a && a.id && this.setState(this.state.delete(a.id))
                    }
                }, {
                    key: "getItemState",
                    value: function(a) {
                        if (a = this.state.get(a)) return a.toJS()
                    }
                }, {
                    key: "getItemDirtyState",
                    value: function(a) {
                    ...
                    value: function(a, b) {
                        var c =
                            this.state.get(a);
                        return d.fetch(a, !1, b).then(function(a) {
                            return c ? a.merge(c.toJS()) : a
                        })
                    }
                }]);
                return a
            }();
        g.exports = b.createStore(a(m), "YUIStagedContentItemStore")
    },
    1116: function(g, b) {
        g.exports = function(a) {
            ...
            a.namespace("Squarespace").ContentCollectionUtils = {
                groupCollectionsByTypeName: function(b) {
                    for (var d = {}, e = 0; e < b.length; e++) {
                        var h = b[e];
                        if (!h.get("isDemoCollection")) {
                            h = h.get("typeName");
                            if (!d[h]) {
                                var g = k.getState().collectionConfigs[h];
                                d[h] = {
                                    title: g ? g.title : "Unknown",
                                    collections: []
                                }
                            }
                            d[h].collections.push(b[e])
                        }
                    }
                    return a.Object.values(d)
                },
                getIconClassNames: function(a) {
                    var b = a.getTemplateConfiguration(),
                        c = "";
                    b && b.get("supported") && (c = b.get("icon"));
                    "" === c && (b && b.get("collectionType") === e.TEMPLATE_PAGE) && (c = "template-page");
                    "" === c && (c = a.get("typeName"));
                    return c
                },
                filterCollections: function(b, d) {
                    var k = ["collectionType", "ordering", "folder", "index"];
                    return a.Squarespace.ContentCollectionCache.filter(function(h) {
                        if (a.Lang.isArray(d) && -1 !== d.indexOf(h.get("id")) || h.get("isDemoCollection") && h.get("type") !== e.TEMPLATE_PAGE) return !1;
                        var g = !0,
                            s = h.getTemplateConfiguration(),
                            q;
                        for (q in b)
                            if (g = b[q], a.Lang.isArray(g) || (g = [g]), g = a.Array.some(g, function(b, d) {
                                    var e;
                                    e = q;
                                    e = -1 !== k.indexOf(e) ? a.Lang.isValue(s) && s.get(e) === b : h.get(e) === b;
                                    return e
                                }), !g) break;
                        return g
                    })
                ...
                isTemplatePage: function(a) {
                    return a.get("type") === e.TEMPLATE_PAGE
                },
                isIndex: function(a) {
                    return (a = a.getTemplateConfiguration()) && a.get("folderBehavior") == h.INDEX ? !0 : !1
                },
                isFolder: function(a) {
                    return (a = a.getTemplateConfiguration()) && a.get("folder")
                },
                isVanillaFolder: function(a) {
                    return this.isFolder(a) && !this.isIndex(a)
                },
                isAdjustablePageSizeCollection: function(b) {
                    var d = k.getCollectionConfig(b.get("typeName")),
                        d = d && d.forcePageSize,
                        h = b.get("type") ===
                        e.COLLECTION_TYPE_GENERIC,
                        g = this._getCollectionOrdering(b) === a.Squarespace.CollectionOrdering.CHRONOLOGICAL;
                    return !d && !this.isIndex(b) && !this.isFolder(b) && h && g
                },
                isBlog: function(b) {
                    return !this.isGenericOrProduct(b) || this.isFolder(b) || this.isIndex(b) ? !1 : this._getCollectionOrdering(b) == a.Squarespace.CollectionOrdering.CHRONOLOGICAL ? !0 : !1
                },
                _getCollectionOrdering: function(a) {
                    return a.get("ordering") || a.getTemplateConfiguration().get("ordering")
                },
                isPostableByEmailAddress: function(b) {
                    var d = this._getCollectionOrdering(b);
                    return !this.isIndex(b) && !this.isFolder(b) && b.get("type") === e.COLLECTION_TYPE_GENERIC && d !== a.Squarespace.CollectionOrdering.CALENDAR && d !== a.Squarespace.CollectionOrdering.CUSTOM && d !== a.Squarespace.CollectionOrdering.MUSIC_ALBUM
                },
                isSupportedByBookmarklet: function(b) {
                    return !this.isIndex(b) && !this.isFolder(b) && b.get("type") === e.COLLECTION_TYPE_GENERIC && this._getCollectionOrdering(b) === a.Squarespace.CollectionOrdering.CHRONOLOGICAL
                },
                hasSupportForInjectableCodePerItem: function(b) {
                    return !this.isIndex(b) &&
                        !this.isFolder(b) && b.get("type") === e.COLLECTION_TYPE_GENERIC && this._getCollectionOrdering(b) === a.Squarespace.CollectionOrdering.CHRONOLOGICAL
                },
                hasSupportForSyndication: function(b) {
                    return !this.isIndex(b) && !this.isFolder(b) && b.get("type") === e.COLLECTION_TYPE_GENERIC && this._getCollectionOrdering(b) === a.Squarespace.CollectionOrdering.CHRONOLOGICAL
                },
                isDemoCollectionId: function(b) {
                    var e = k.getState().demoCollections;
                    return !e ? !1 : !!a.Array.find(e, function(a) {
                        return a.collectionId == b
                    })
                },
                isGenericOrProduct: function(a) {
                    a =
                        a.getTemplateConfiguration();
                    return !a ? !1 : !1 === a.get("folder") && (a.get("collectionType") === e.PRODUCTS || a.get("collectionType") === e.COLLECTION_TYPE_GENERIC)
                },
                isProduct: function(a) {
                    var b = a.getTemplateConfiguration();
                    return !b || a.get("isDemoCollection") ? !1 : !1 === b.get("folder") && b.get("collectionType") === e.PRODUCTS
                },
                isPage: function(a) {
                    a = a.getTemplateConfiguration();
                    return !a ? !1 : !1 === a.get("folder") && a.get("collectionType") === e.COLLECTION_TYPE_PAGE
                },
                isNotCalendar: function(b) {
                    return b.getTemplateConfiguration().get("ordering") ===
                        a.Squarespace.CollectionOrdering.CALENDAR ? !1 : !0
                },
                ...
                getIdentifierForCollection: function(b) {
                    ...
                    var d = b.get("typeName");
                    !d && b.get("type") === e.COLLECTION_TYPE_PAGE && (b.set("typeName", "page"), d = "page");
                    var h = b.get("type");
                    if (h === e.COLLECTION_TYPE_GENERIC) {
                        var g = b.get("ordering");
                        a.Lang.isValue(g) || (g = k.getCollectionConfig(d), d = k.getPageConfig(d),
                            g = (g || d).ordering);
                        if (a.Squarespace.ContentCollectionUtils.isIndex(b)) return "INDEX";
                        if (g === a.Squarespace.CollectionOrdering.USER) return "GALLERY";
                        if (g === a.Squarespace.CollectionOrdering.CHRONOLOGICAL) return "BLOG";
                        if (g === a.Squarespace.CollectionOrdering.CALENDAR) return "CALENDAR";
                        if (g === a.Squarespace.CollectionOrdering.MUSIC_ALBUM) return "MUSIC_ALBUM";
                        if (g === a.Squarespace.CollectionOrdering.KNOWLEDGE_BASE) return "KNOWLEDGE_BASE"
                    }
                    if (h === e.COLLECTION_TYPE_PAGE) return "PAGE";
                    if (h === e.PRODUCTS) return "PRODUCT";
                    if (h === e.TEMPLATE_PAGE) return "TEMPLATE_PAGE"
                }
            }
        }, "1.0", {
            ...
            a.Squarespace.Mixins.EventList = a.Base.create("EventList", a.Base, [], {
                initializer: function() {
                    a.Do.before(function(b) {
                            var c = a.Object.hasKey(b, "upcoming"),
                                f = a.Object.hasKey(b, "past");
                            if (c && f) return new a.Do.AlterArgs(k("Parsing calendar-specific response"), [
                ...
                getPastEvents: function() {
                    ...
                    return this.filter(function(c) {
                        ...
                        if (null === c) return !1;
                        c = a.DataType.Date.parse(c.get("endDate"));
                        return a.DataType.Date.isGreater(b, c)
                    })
                },
    ...
    1152: function(g, b) {
        YUI.add("squarespace-models-calendar-event", function(a) {
                a.namespace("Squarespace.Models");
                a.Squarespace.Models.CalendarEvent = a.Base.create("CalendarEvent",
                    a.Squarespace.Models.StructuredContent, [], {}, {
                        ATTRS: {
                            _type: {
                                value: "CalendarEvent",
                                validator: function(a) {
        ...
        YUI.add("squarespace-models-collection-configuration", function(a) {
                ...
                a.Squarespace.Models.CollectionConfiguration = a.Base.create("CollectionConfiguration", a.Model, [], {
                    initializer: function(b) {
                        a.Lang.isBoolean(b.index) && b.index ? this.set("folderBehavior", e.INDEX) : a.Lang.isBoolean(b.folder) && b.folder && this.set("folderBehavior", e.NONE)
                    }
                }, {
                    ATTRS: {
                        collectionType: {
                            value: k.COLLECTION_TYPE_GENERIC
                        },
                        folder: {
                            value: !1
                        },
        ...
        YUI.add("squarespace-models-content-collection", function(a) {
            ...
            var b = a.Squarespace.Models.ContentCollection = a.Base.create("Collection", a.Model, [], {
                initializer: function(b) {
                    ...
                    this._itemsEventHandle = this.items.after(["load", "add", "remove"], this._updateItemCount, this);
                    ...
                    this.unlistenToModelStore = f.listen(this._handleStoreChange.bind(this))
                },
                destructor: function() {
                ...
                parse: function(a) {
                    ...
                    a.passwordProtected && (a.password = l.PASSWORD_MASK);
                    return a
                },
                sync: function(a, b, c) {
                    switch (a) {
                ...
                resetToLastRead: function() {
                    return f.fetch(this.get("id")).then(function(b) {
                        var c = this.getAttrs();
                    ...
                    var b = function(c) {
                        this.items.load({
                            ...
                            this.items.some(function(a) {
                                return a.get("mediaProcessingState") !== m.READY
                ...
                _ensureDemoCloneAndSave: function(b) {
                    if (this._shouldCloneCollection()) {
                        ...
                        this.cloneToNewCollection({
                            silent: !0
                        }).then(a.bind(this._save,
                            this, b, c))
                    } else this._save(b)
                },
                _handleStoreChange: function(a) {
                    if (a = a.get(this.getId())) this.setAttrs(this.parse(a.toJS())), this.set("dirty", !1)
                },
                serialize: function(b) {
                    ...
                    delete b.mainImage;
                    b.metadata && b.metadata.albumCover &&
                        delete b.metadata.albumCover;
                    b.productQuickViewEnabled && (b.features.productQuickView.isEnabled = b.productQuickViewEnabled, delete b.productQuickViewEnabled);
                ...
                _save: function(a, b) {
                    b = this.serialize(b);
                    c.update(b).then(function(b) {
                        b.error ? a(b, null) : (this._initialAttrs = b, a(null, b))
                    }).catch(this._errorHandler)
                },
                _delete: function(a) {
                    c.delete(this.get("id")).then(function(b) {
                        a(null,
                            b)
                    }, function(b) {
                        a(b, null)
                ...
                _deleteUnusedCollectionPermanently: function(a) {
                    c.deleteUnusedCollectionPermanently(this.get("id")).then(function(b) {
                        a(null, b)
                    }, function(b) {
                        a(b, null)
                    }).catch(this._errorHandler)
                ...
                _read: function(b, c) {
                    ...
                    f.fetch(this.get("id")).then(function(b) {
                        var e = this.parse(b.toJS());
                        a.Squarespace.ContentCollectionUtils.usesDisplayIndex(e.ordering) ? this._fetchItemCount(e.id).then(function(a) {
                                this._readInProgress = !1;
                                e.itemCount = a;
                                c(null, e)
                            }.bind(this)) :
                            (this._readInProgress = !1, c(null, e))
                ...
                _updateItemCount: function() {
                    a.Squarespace.ContentCollectionUtils.usesDisplayIndex(this.get("ordering")) && (this.isNew() ? this.set("itemCount", 0) : this._fetchItemCount(this.get("id")).then(function(a) {
                ...
                getTemplateConfiguration: function() {
                    ...
                    b = this.get("typeName");
                    var c = this.get("type");
                    return (b = c === d.TEMPLATE_PAGE ? h.getPageConfig(b) : h.getCollectionConfig(b)) ? new a.Squarespace.Models.CollectionConfiguration(b) : new a.Squarespace.Models.CollectionConfiguration({
                        collectionType: c || d.COLLECTION_TYPE_GENERIC,
                ...
                cloneToNewCollection: function(b) {
                    return new a.Promise(a.bind(function(c,
                        e) {
                        var d = a.Squarespace.Singletons.TemplateNavigationList.getItemByCollectionId(this.get("id"));
                        this._cloneExampleContent(b).then(a.bind(function(a) {
                            d.set("collectionId", a);
                            d.save(c)
                        }, this))
                    }, this))
                },
                _cloneExampleContent: function(b) {
                    b = b || {};
                    var c = new a.Promise(a.bind(function(c, d) {
                        var f = this.get("id");
                        a.Data.post({
                            ...
                            success: function(b) {
                                ...
                                var g = b.id;
                                k.getHomepageCollectionId() === f ? e.setHomepageCollectionId(g).then(function(a) {
                                    a.error ? d() : c(g)
                                }) : c(g)
                            }
                        }, this)
                ...
                _shouldCloneCollection: function() {
                    return this.get("isDemoCollection") && this.get("type") === d.COLLECTION_TYPE_PAGE
                },
                ...
                ATTRS: {
                    ...
                    itemCountExceeded: {
                        getter: function() {
                            return this.get("type") == d.PRODUCTS && this.get("itemCount") >= this.get("maxItemCount") ? !0 : !1
                        }
                    },
                    itemCount: {
                    ...
                    maxItemCount: {
                        getter: function() {
                            return this.get("type") == d.PRODUCTS ? 200 : 9999
                        }
                    },
                    tags: {
                        value: [],
                    ...
                    pageSize: {
                        validator: a.Lang.isNumber,
                        valueFn: function() {
                            if (this.getTemplateConfiguration().get("ordering") === r.CHRONOLOGICAL) return 20
                        }
                    },
                    itemLimit: {
                        value: 20,
                    ...
                    ordering: {
                        validator: function(b) {
                            return a.Object.values(r).includes(b)
                        }
                    },
                    type: {
                        validator: function(b) {
                            return a.Object.values(d).includes(b)
                        }
                    },
                    typeName: {
                        validator: a.Lang.isString
                    ...
                    regionName: {
                        value: "default",
                        validator: function(b) {
                            return !a.Lang.isString(b) || 0 === b.length ? !1 : a.Object.keys(h.getState().layouts).includes(b)
                        }
                    },
                    postByEmailAddress: {
                        getter: function(a) {
                            return a ? a + "@squarespace.com" : ""
                        }
                    }
                }
            });
            a.Squarespace.Models.ContentCollectionList = a.Base.create("Collections", a.ModelList, [], {
                ...
                sync: function(a, b, e) {
                    "read" == a && c.readAll().then(function(a) {
                        e(null, a)
                    }, function(a) {
                        e(a,
                            null)
                ...
                getCollectionById: function(b, c, e) {
                    ...
                    d ? c.call(e, d) : (d = new a.Squarespace.Models.ContentCollection({
                        id: b
                    }), d.load({}, function() {
                        this.add(d);
                        c.call(e, d)
                ...
                getCollectionFromData: function(b, c) {
                    ...
                    e ? c || e.setAttrs(b) : e = this.add(new a.Squarespace.Models.ContentCollection(b));
                    return e
                }
            });
            ...
            function(a) {
                ...
                var b = a.Squarespace.Models.ContentItemList = a.Base.create("ContentItemList", a.ModelList, [a.Squarespace.Mixins.EventList], {
                    ...
                    load: function(a, e) {
                        ...
                        b.superclass.load.call(this, a, e)
                    },
                    removeItems: function(b, f) {
                        this.remove(b, {
                            source: "bulk-remove"
                        });
                        var d = a.Array.map(b, function(a) {
                            var b = a.get("id");
                            a.destroy();
                            return b
                        }, this);
                    ...
                    moveItems: function(b, f, d) {
                        ...
                        a.Data.post({
                            ...
                            success: function(g) {
                                this.get("parent").load();
                                a.Lang.isFunction(d) && d(null, g);
                                this.fire("move-items", b, f)
                            },
                            failure: function(b) {
                    ...
                    reorderItems: function(b, f, d) {
                        var g = this.get("parent"),
                            h = {};
                        this.get("isChildItemList") ? (h.collectionId =
                            g.get("collectionId"), h.parentId = g.get("id")) : h.collectionId = g.get("id");
                        var k = 1 === b.length,
                            s;
                        k ? (b = b[0], s = this.indexOf(this.getById(b.get("id"))), this._reorder([b], f), 0 !== f && (h.afterId = this.item(f - 1).get("id")), h.itemId = b.get("id")) : (this._reorder(b, f), 0 !== f && (h.afterId = this.item(f - 1).get("id")), b = a.Array.map(b, function(a) {
                            return a.get("id")
                        }, this), h.itemIds = a.JSON.stringify(b));
                        var q = a.bind(function(b) {
                            a.Data.post({
                                ...
                                success: function(b) {
                                    ...
                                    a.Lang.isUndefined(b.items) || a.Array.each(b.items, function(a, b) {
                                        this.getById(a.id).set("displayIndex", a.displayIndex)
                                    }, this);
                                    this.fire("reordered");
                                    a.Lang.isFunction(d) && d(null, b);
                                    0 < this._reorderQueue.size() && q(thie._reorderQueue.next())
                                },
                                failure: function(b) {
                                    a.Lang.isFunction(d) && d(b, null)
                                }
                    ...
                    _getReadUrl: function() {
                        var b = this.get("parent"),
                            f = k.getTemplateForCollectionItems(b.get("ordering"),
                                b.get("type"));
                        return a.Lang.sub(f, {
            ...
            var b = a.Squarespace.Models.ContentItem = a.Base.create("Item", a.Model, [], {
                ...
                _save: function(a, b) {
                    ...
                    c.collectionId ? d.updateForCollection(c, b).then(function(b) {
                            this._initialAttrs = b;
                            a(null, b)
                        }, function(b) {
                            a(b, null)
                        }).catch(this._errorHandler) :
                        d.update(c).then(function(b) {
                            this._initialAttrs = b;
                            a(null, b)
                        }, function(b) {
                            a(b, null)
                ...
                _create: function(a, b, c) {
                    ...
                    e.collectionId ? d.createForCollection(e, a, c).then(function(a) {
                        b(null, a)
                    }, function(a) {
                        b(a, null)
                    }).catch(this._errorHandler) : d.create(e, a).then(function(a) {
                        b(null, a)
                    }, function(a) {
                        b(a, null)
                    }).catch(this._errorHandler)
                ...
                _read: function(a, b, c) {
                    this.get("isGlobalFakeContentItem") ? this._readGlobalFakeContentItem(this.get("id"), a, b) : (this._readInProgress = !0, a.forceReload ? d.read(this.get("id"), !1, c).then(function(a) {
                        this._readInProgress = !1;
                        a = a ? a.toJS() : a;
                        b(null, a)
                    }.bind(this), function(a) {
                        this._readInProgress = !1;
                        b(a, null)
                    }.bind(this)).catch(this._errorHandler) : r.fetchStaged(this.get("id"), c).then(function(a) {
                        this._readInProgress = !1;
                        b(null, a.toJS())
                    }.bind(this), function(a) {
                        this._readInProgress = !1;
                ...
                initializer: function(a) {
                    ...
                    a = this.get("items");
                    a.after(["add", "remove"], function() {
                        this._updateNextDisplayIndex();
                        m.updateAttributes(this.getId(), {
                ...
                destructor: function() {
                    ...
                    this._actionListeners && this._actionListeners.forEach(function(a) {
                        f.removeActionListener(a)
                    })
                },
                bindListenersToContentStores: function() {
                    this._actionListeners = [];
                    this._actionListeners.push(f.addActionListener(m.UPDATE_ATTRIBUTES, this._onUpdate.bind(this)));
                    this._actionListeners.push(f.addActionListener(m.RESET, this._onReset.bind(this)));
                    this._actionListeners.push(f.addActionListener(d.INSERT, this._onInsert.bind(this)))
                },
                _onUpdate: function(b) {
                    this.get("id") === a.Object.getValue(b, ["itemId"]) && this._setAttrsInOrder(b.attrs)
                },
                _onReset: function(b) {
                    this.get("id") === a.Object.getValue(b, ["id"]) && l.fetch(this.get("id")).then(function(b) {
                        var c = this.getAttrs();
                        a.Object.keys(c).map(function(a) {
                            c[a] =
                                void 0
                        });
                        b = a.merge(c, this._initialAttrs, b.toJS());
                        this._setAttrsInOrder(b)
                    }.bind(this)).catch(this._errorHandler)
                },
                _onInsert: function(b) {
                    if (this.get("id") === a.Object.getValue(b, ["id"])) {
                        var c = r.getItemState(this.getId());
                        this._setAttrsInOrder(a.merge(b, c))
                    }
                },
                _getParentCollection: function() {
                    return new a.Promise(function(b, c) {
                        var d = this.get("collectionId");
                        d ? a.Squarespace.ContentCollectionCache.getCollectionById(d, b) : b(null)
                    }.bind(this))
                },
                _setAttrsInOrder: function(a) {
                    if (a && a.mediaProcessingState) {
                        var b =
                            Object.keys(a).filter(function(a) {
                                return "mediaProcessingState" !== a
                            }).reduce(function(b, c) {
                                b[c] = a[c];
                                return b
                            }, {});
                    ...
                    } else this.setAttrs(a)
                },
                updateAttributes: function(a, b) {
                    this.setAttrs(a, b);
                    m.updateAttributes(this.getId(), a)
                },
                toJSON: function() {
                    var c = b.superclass.toJSON.call(this),
                        d = c.structuredContent;
                    a.Lang.isValue(d) && (c.structuredContent = d.toJSON());
                    c.items = c.items.toJSON();
                    a.Lang.isObject(c.pushedServices) && (c.pushedServices =
                        a.Object.keys(c.pushedServices));
                ...
                _attachWorkflowToData: function(b) {
                    a.Lang.isValue(b.workflow) &&
                        (b.workflowState = this._getWorkflowStateForString(b.workflow.state), b.publishOn = b.workflow.date, delete b.workflow)
                },
                ...
                _normalizeDates: function(b) {
                    a.Array.each("addedOn publishOn updatedOn commentDisableOn startDate endDate".split(" "), function(c, d) {
                            a.Lang.isDate(b[c]) && (b[c] = b[c].getTime())
                        },
                        this)
                },
                save: function(c, d) {
                    this.isNew() || !a.Lang.isObject(c) || !c.fields ? b.superclass.save.call(this, c, d) : this._saveFields(c.fields, d)
                },
                ...
                clearFileData: function(b) {
                    ...
                    this._getParentCollection().then(this._getUrlDeterminants.bind(this)).then(function(b) {
                        var c = this.get("id");
                        b = q.getMainImageDeletionUrl(b).replace("{id}", c);
                        a.Data.del({
                            url: b,
                            data: {
                                itemId: c
                ...
                getMainImageUploadUrl: function(a) {
                    this._getParentCollection().then(this._getUrlDeterminants.bind(this)).then(function(b) {
                        a(q.getMainImageUploadUrl(b).replace("{id}", this.get("id")))
                    }.bind(this))
                },
                _needsJobListener: function() {
                    var a = this.get("mediaProcessingState");
                    return a === e.QUEUED || a === e.PROCESSING
                },
                _bindJobListener: function() {
                    Static && Static.JOB_MANAGER && (this._jobListener = a.config.win.Static.JOB_MANAGER.on("completed", function(b) {
                        var c = b.job;
                        b = this.get("id");
                        var d = c.get("data.contentItemId"),
                            c =
                            c.get("data.globalContentItemId");
                        d === b ? (this.load({
                            forceReload: !0
                ...
                _saveFields: function(b, c) {
                    if (1 <
                        b.length) throw Error("Saving multiple fields is not currently supported.");
                    var e = b[0],
                        e = {
                            field: e,
                            itemId: this.get("id"),
                ...
                ATTRS: {
                    ...
                    recordType: {
                        validator: a.Squarespace.AttrValidators.isValueIn(h),
                        writeOnce: !0
                    },
                    childType: {
                        value: null,
                    ...
                    workflowState: {
                        value: c.DRAFT,
                        validator: a.Squarespace.AttrValidators.isValueIn(c)
                    },
                    systemDataId: {
                        value: null,
                        validator: a.Squarespace.AttrValidators.isNullOrString
                    ...
                    mediaProcessingState: {
                        value: null,
                        validator: a.Squarespace.AttrValidators.isNullOr(a.Squarespace.AttrValidators.isValueIn(e))
                    },
                    mediaFocalPoint: {
                        value: {
                            x: 0.5,
                    ...
                    commentState: {
                        valueFn: function() {
                            var a = s.getState().toJS(),
                                b = a.commentsEnabled;
                            return a.commentEnableByDefault && b ? k.ENABLED : k.DISABLED
                        },
                    ...
                    dirty: {
                        getter: function() {
                            return r.getItemDirtyState(this.get("id"))
                        }
                    }
                }
            })
        ...
        YUI.add("squarespace-models-store-item", function(a) {
            ...
            a.Squarespace.Models.StoreItem = a.Base.create("StoreItem", a.Squarespace.Models.StructuredContent, [], {}, {
                ATTRS: {
                    ...
                    productType: {
                        value: e.PHYSICAL,
                        validator: a.Squarespace.AttrValidators.isValueIn(e)
                    },
                    priceCents: {
                        value: 0,
                        validator: a.Squarespace.AttrValidators.isNumber
    ...
    3576: function(g, b, a) {
        ...
        YUI.add("squarespace-simple-liking", function(a) {
            ...
            a.Squarespace.SimpleLike = {
                TEXT_LIKE_VERB_NONE: k("No Likes"),
                TEXT_LIKE_VERB_SINGULAR: "Like",
                TEXT_LIKE_VERB_PLURAL: "Likes",
                TEXT_LIKE_ACTIVATED: k("You like this"),
                TEXT_LIKE_SUGGEST: k("Click to like"),
                attached: !1,
                attach: function() {
                    if (!this.attached) {
                        this.attached = !0;
                        var c;
                        try {
                            localStorage && ((c = a.JSON.parse(localStorage.getItem("squarespace-likes"))) || (c = {}), localStorage.setItem("squarespace-likes", a.JSON.stringify(c)))
                        } catch (f) {
                            c = {}
                        }
                        this.eventHandlers = [];
                        var d = a.delegate("click", function(b) {
                            b = b.currentTarget;
                            var d = b.getAttribute("data-item-id");
                            if (d) {
                                for (var f = 0; 5 > f; ++f) a.Squarespace.SimpleLike.burst(b);
                                if (!b.hasClass("clicked") && !b.hasClass("float")) {
                                    f = parseInt(b.getAttribute("data-like-count"), 10);
                                    b.setAttribute("data-like-count", f + 1);
                                    a.Squarespace.SimpleLike.renderLikeCount(b);
                                    b.addClass("clicked");
                                    try {
                                        localStorage && (c[d] = !0, localStorage.setItem("squarespace-likes", a.JSON.stringify(c)))
                                    } catch (g) {
                        ...
                        this.eventHandlers.push(d);
                        a.all(".sqs-simple-like").each(function(d) {
                            var f = d.getAttribute("data-item-id");
                            f && (b.SQUARESPACE_CONTEXT.websiteSettings.simpleLikingEnabled || d.remove(), c[f] && d.addClass("clicked"), a.Squarespace.SimpleLike.renderLikeCount(d))
                        })
                    }
                },
                detach: function() {
                ...
                renderLikeCount: function(b) {
                    var f =
                        ...
                        d = b.getAttribute("data-like-count");
                    b = b.one(".like-count");
                    f && b && (f = "", f = 0 === d ? a.Squarespace.SimpleLike.TEXT_LIKE_VERB_NONE : 1 == d ? "1 " + a.Squarespace.SimpleLike.TEXT_LIKE_VERB_SINGULAR : d + " " + a.Squarespace.SimpleLike.TEXT_LIKE_VERB_PLURAL, b.setContent(f))
                },
                burst: function(b) {
                    var f = b.cloneNode(!0);
                    f.one(".like-count") && f.one(".like-count").remove();
                    var d = b.one(".like-icon");
                    if (!d || "none" === d.getStyle("display")) d = b;
                    f.setStyles({
                        position: "absolute",
                        left: d.getX() + "px",
                        top: d.getY() +
                    ...
                    a.one(a.config.doc.body).append(f);
                    b = new a.Anim({
                        node: f,
                        duration: 2,
                    ...
                    b.set("to", {
                        curve: a.Squarespace.SimpleLike.randomCurve(f)
                    });
                    b.on("end", function() {
                ...
                randomCurve: function(a) {
                    var b = [],
                        d = Math.floor(2 * Math.random()) ? 1 : -1,
                        e = Math.floor(2 * Math.random()) ? 1 : -1,
                        g = a.getX();
                    a = a.getY();
                    for (var h = 0; 3 > h; ++h) g += Math.floor(30 * Math.random()) * d, a += Math.floor(30 * Math.random()) * e, b.push([g, a]);
                    return b
                }
            };
