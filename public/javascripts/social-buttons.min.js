webpackJsonp([34], {
            ...
            var g = function(c) {
                ...
                e = d.Squarespace.SocialButton = d.Base.create("socialButton", d.Widget, [], {
                    initializer: function(c) {
                        ...
                        c.services.forEach(function(a) {
                            this._servicesRendered[a] = !1
                        }, this);
                        this._open = !1;
                        this._anims = {};
                        this._serviceRenderers = {};
                        this._serviceRenderers[b.REDDIT] = this._renderReddit;
                        this._serviceRenderers[b.FACEBOOK] = this._renderFacebook;
                        this._serviceRenderers[b.TWITTER] = this._renderTwitter;
                        this._serviceRenderers[b.GOOGLE] = this._renderGoogle;
                        this._serviceRenderers[b.LINKEDIN] = this._renderLinkedIn;
                        this._serviceRenderers[b.STUMBLE] = this._renderStumble;
                        this._serviceRenderers[b.PINTEREST] = this._renderPinterest;
                        this._serviceRenderers[b.TUMBLR] = this._renderTumblr;
                    ...
                    _defaultServiceRendered: function(c) {
                        this._servicesRendered[c.details[0]] = !0;
                        this._allServicesRendered() && (this.set("loaded", !0), this.fire("servicesRendered",
                            this))
                    },
                    open: function() {
                        this._open = !0;
                    ...
                    _onClick: function(c) {
                        this.fire("buttonClicked", c)
                    },
                    _defaultButtonClicked: function(c) {
                    ...
                    _stopAnimations: function() {
                        d.Object.values(this._anims).forEach(function(c) {
                            c.stop()
                        })
                    },
                    _closeList: function() {
                        ...
                        if (c._node && c.inDoc()) {
                            var a = c.one(".ss-social-button-wrapper"),
                                b = c.one(".ss-social-list-wrapper"),
                                c = a.get("offsetWidth");
                            a.get("offsetHeight");
                            a = b.get("offsetWidth");
                            Math.abs(c - a);
                            b && (b._node && b.inDoc()) && (a = new d.Anim({
                                node: b,
                                duration: 0.3,
                    ...
                    _openList: function() {
                        ...
                        if (c._node && c.inDoc()) {
                            ...
                            a = a.left - k.left;
                            k = 0 < a;
                            0 < e && b.setStyle("top", parseInt(b.getComputedStyle("top"), 10) - e - 20);
                            k && b.setStyle("left", parseInt(b.getComputedStyle("left"),
                                10) + a + 20);
                            b && (b._node && b.inDoc()) && (c = new d.Anim({
                                node: b,
                                duration: 0.3,
                                easing: d.Easing.easeOutStrong,
                                to: {
                            ...
                            }), this._anims.open = c, c.on("end", function() {
                                    b.setStyle("overflow", "visible");
                                    var a = d.config.win.document;
                                    d.UA.touchEnabled && d.one(a.documentElement).setStyle("cursor", "pointer");
                                    l = d.one(a).on("click", function(b) {
                                        b.target.ancestor(".ss-social-list-wrapper", !0) || (this.fire("close"), l.detach(), l = null, d.one(a.documentElement).setStyle("cursor", ""))
                                    }, this);
                                    this.fire("listOpen")
                                },
                                this), c.run())
                    ...
                    _defaultTimeoutCb: function(c, a) {
                        var f = d.Squarespace.Utils.reverseMap(b),
                            h = p(l("(Social Button) Loading render script for service: {name} too longer than {sub1} seconds. Skipping."), {
                                sub1: e.SCRIPT_TIMEOUT /
                                    1E3
                            });
                        return function() {
                            console.warn(d.substitute(h, {
                                name: f[c]
                            }));
                            this.fire("serviceRendered", c);
                            a && a.hide()
                        }
                    },
                    _defaultFailureCb: function(c, a) {
                        var e = d.Squarespace.Utils.reverseMap(b),
                            h = l("(Social Button) Service {name} render script failed to load.");
                        return function() {
                            console.warn(d.substitute(h, {
                                name: e[c]
                            }));
                    ...
                    _renderReddit: function(c) {
                        ...
                        a.on("click", function(a) {
                            window.open("http://reddit.com/submit?url=" + encodeURIComponent(f), l("Submit to Reddit"));
                            a.stopImmediatePropagation()
                        });
                        c.append(a);
                        this.fire("serviceRendered", b.REDDIT)
                    },
                    _renderTumblr: function(c) {
                        var a = this._serviceContainer.cloneNode(!0),
                            f = {
                                url: this.get("url"),
                                name: this.get("title")
                            },
                            f = d.QueryString.stringify(f);
                        a.addClass("tumblr");
                        ...
                        d.Get.script(e.TUMBLR_URL, {
                            ...
                            onFailure: this._defaultFailureCb(b.TUMBLR, a),
                            onTimeout: this._defaultTimeoutCb(b.TUMBLR, a),
                            timeout: e.SCRIPT_TIMEOUT,
                            context: this,
                            win: d.config.win
                        })
                    },
                    _renderFacebook: function(c) {
                        var a = this._serviceContainer.cloneNode(!0),
                            f = this.get("url");
                        a.addClass("facebook");
                        ...
                        d.Get.script(e.FACEBOOK_URL, {
                            onSuccess: function() {
                                h.FB && d.later(400, this, function() {
                                    h.FB.init({
                                        appId: k,
                                        xfbml: !1,
                                        version: "v2.5"
                                    });
                                    h.FB.XFBML && h.FB.XFBML.parse && h.FB.XFBML.parse();
                                    this.fire("serviceRendered", b.FACEBOOK)
                                })
                            },
                            onFailure: this._defaultFailureCb(b.FACEBOOK, a),
                            onTimeout: this._defaultTimeoutCb(b.FACEBOOK, a),
                            timeout: e.SCRIPT_TIMEOUT,
                            context: this
                        })
                    },
                    _renderGoogle: function(c) {
                        var a = this._serviceContainer.cloneNode(!0),
                            f = this.get("url");
                        a.addClass("google");
                        ...
                        d.Get.script(e.GOOGLE_PLUS_URL, {
                            onSuccess: function() {
                                window.gapi &&
                                    (gapi.plusone.go(), d.later(400, this, function() {
                                        this.fire("serviceRendered", b.GOOGLE);
                                        this._googleRendered = !0
                                    }))
                            },
                            onFailure: this._defaultFailureCb(b.GOOGLE, a),
                            onTimeout: this._defaultTimeoutCb(b.GOOGLE, a),
                            timeout: e.SCRIPT_TIMEOUT,
                            context: this
                        });
                        this.fire("serviceRendered", b.GOOGLE)
                    },
                    _renderTwitter: function(c) {
                        var a = this._serviceContainer.cloneNode(!0),
                            f = this.get("title"),
                            h = this.get("url");
                        a.append(d.Node.create('<a href="https://twitter.com/share" data-text="' + d.Escape.html(f || "") + '" data-url="' + d.Escape.html(h) +
                        ...
                        d.Get.script(e.TWITTER_URL, {
                            onSuccess: function() {
                                d.later(400, this, function() {
                                    this.fire("serviceRendered", b.TWITTER)
                                })
                            },
                            onFailure: this._defaultFailureCb(b.TWITTER, a),
                            onTimeout: this._defaultTimeoutCb(b.TWITTER, a),
                            timeout: e.SCRIPT_TIMEOUT,
                            context: this
                        })
                    },
                    _renderLinkedIn: function(c) {
                        var a = this._serviceContainer.cloneNode(!0);
                        this.get("title");
                        var f = this.get("url");
                        a.addClass("linkedin");
                        ...
                        d.Get.script(e.LINKEDIN_URL, {
                            onSuccess: function() {
                                d.later(400, this, function() {
                                    this.fire("serviceRendered", b.LINKEDIN)
                                })
                            },
                            onFailure: this._defaultFailureCb(b.LINKEDIN, a),
                            onTimeout: this._defaultTimeoutCb(b.LINKEDIN, a),
                            timeout: e.SCRIPT_TIMEOUT,
                            context: this
                        })
                    },
                    _renderStumble: function(c) {
                        var a = this._serviceContainer.cloneNode(!0),
                            f = this.get("url"),
                            h = this.get("id");
                        a.addClass("stumble");
                        ...
                        d.Get.script(e.STUMBLE_URL, {
                            onSuccess: function() {
                                d.later(400, this, function() {
                                    ...
                                    this.fire("serviceRendered", b.STUMBLE)
                                })
                            },
                            onFailure: this._defaultFailureCb(b.STUMBLE, a),
                            onTimeout: this._defaultTimeoutCb(b.STUMBLE, a),
                            timeout: e.SCRIPT_TIMEOUT,
                            context: this
                        })
                    },
                    _renderPinterest: function(c) {
                        var a = this._serviceContainer.cloneNode(!0),
                            f = this.get("assetUrl"),
                            h = this.get("url"),
                            k = Static.SQUARESPACE_CONTEXT.website.authenticUrl +
                            c.ancestor(".squarespace-social-buttons").getAttribute("data-full-url");
                        this.get("id");
                        this.get("recordType");
                        this.get("systemDataId") ? (a.addClass("pinterest"), a.append(d.Node.create(d.substitute(e.PINTEREST_TAG_TEMPLATE, {
                            url: encodeURIComponent(f || h),
                            pageUrl: encodeURIComponent(k)
                        }))), c.append(a), d.Get.script(e.PINTEREST_URL, {
                            onSuccess: function() {
                                d.later(400, this, function() {
                                    this.fire("serviceRendered", b.PINTEREST)
                                }, this)
                            },
                            onFailure: this._defaultFailureCb(b.PINTEREST, a),
                            onTimeout: this._defaultTimeoutCb(b.PINTEREST,
                                a),
                            timeout: e.SCRIPT_TIMEOUT,
                            context: this
                        })) : this.fire("serviceRendered", b.PINTEREST)
    ...
    3584: function(m, n, g) {
        var l = g(720),
            p = g(96);
        YUI.add("squarespace-social-buttons", function(b) {
            b.namespace("Squarespace");
            var d = b.config.win.Static,
                g = b.Squarespace.SocialButton,
                e = b.Squarespace.SocialButtons = b.Base.create("socialButtons", b.Base, [], {
                    ...
                    _initializeButtons: function() {
                        this._buttons = b.Array.map(b.Object.values(this._buttonConfigs),
                            function(a) {
                                return new g(a)
                            })
                    },
                    ...
                    _excludeOnlyPinterest: function(a) {
                        return a.get("recordType") !== p.IMAGE && this._onlyServiceIsPinterest(a) ? !1 : !0
                    },
                    _onlyServiceIsPinterest: function(a) {
                        a = a.get("services");
                        return 1 === a.length && a[0] === l.PINTEREST
                    }
                }, {
                    ...
                    ATTRS: {
                        services: {
                            valueFn: function() {
                                return b.Array.map(b.Object.keys(d.SQUARESPACE_CONTEXT.website.shareButtonOptions || {}), function(a) {
            ...
            b.config.win.Squarespace.onInitialize(b, function() {
                c = [];
                b.all(".squarespace-social-buttons").isEmpty() || c.push(new b.Squarespace.SocialButtons)
            });
            b.config.win.Squarespace.onDestroy(b, function() {
